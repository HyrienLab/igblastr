...
date: "Compiled `r BiocStyle::doc_date()`; Modified 24 March 2025"
package: igblastr
vignette: |
...
_If I understood correctly we want to plot the frequency of V genes.
 ...
 something like `head(sort(table(out$v_call), decreasing=TRUE), n=20)`._

_Another thing that might be of interest is make two plots, one for the
