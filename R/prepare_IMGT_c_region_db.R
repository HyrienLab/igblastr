...
### -------------------------------------------------------------------------
###
### Prepare a C-region db from the FASTA files available at IMGT.
### See comment at top of prepare_IMGT_germline_db.R for more information.
###
...
###     <igblastr-cache>
###     └── c_region_dbs
prepare_IMGT_c_region_db <- function(organism_path, destdir, force=FALSE)
{
